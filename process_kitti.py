'''
Code for downloading and processing KITTI data
...
# Were initially chosen randomly such that one of the city recordings was used
# for validation and one of each category was used for testing.
...
def process_data():
    ...
    for split in splits:
        ...
        for category, folder in splits[split]:
            im_dir = os.path.join(DATA_DIR, 'raw/', category, folder, folder[:10],
